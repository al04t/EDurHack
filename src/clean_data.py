...
class CreateDataSet:
    ...
    def __init__(self, input_file, output_dir):
        ...
        self.columns = ['stateProvince', 'year', 'decimalLatitude', 'decimalLongitude']
    ...
    def read_dataset(self):
        try:
            ...
            self.raw_df = pd.read_csv(self.file_path, sep='\t', usecols=self.columns, ow_memory=False)
    ...
    def process_data(self):
        ...
        self.processed_data = df_filtered.groupby(['latitudeGrid', 'longitudeGrid', 'year']).size().reset_index(name='sightingCount')
...
if __name__ == "__main__":
    ...
    try:
        data_processor = CreateDataSet(input_file=INPUT_FILE, output_dir=OUTPUT_FOLDER)
